 ...
 */
public class StackFillResultPayload implements Packet<ClientGamePacketListener> {

    public static final ResourceLocation ID =
            new ResourceLocation(ClientSort.MOD_ID, "stack_fill_result_s2c");
     ...
     */
    public StackFillResultPayload(int result, String message) {
        this.result = result;
    ...
    public static StackFillResultPayload read(FriendlyByteBuf buf) {
        return new StackFillResultPayload(buf.readInt(), buf.readUtf());
    }
