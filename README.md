...
<details open>
<summary><b><img alt="Sort" src="./assets/images/sort.png"> Sort</b></summary>

- Press the <img alt="Sort" src="./assets/images/sort.png"> button, or hover over the inventory with
...
<details>
<summary><b><img alt="Fill Stacks" src="./assets/images/stack_fill_down.png"> Fill Stacks</b></summary>

- Press the <img alt="Fill Stacks" src="./assets/images/stack_fill_down.png"> button, or hover over
...
<details open>
<summary><b><img alt="Transfer" src="./assets/images/transfer_down.png"> Transfer</b></summary>

- Press the <img alt="Transfer" src="./assets/images/transfer_down.png"> button, or hover over the
...
<img alt="Editor" src="./assets/images/editor_01.png" style="width:50%;">
...
- If installed on a server, ClientSort uses policies to automatically disable server-accelerated
  operations when it detects an incorrect state (such as item duplication).
